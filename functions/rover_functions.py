from functions.rover_utils import RoverDomain, PointBSpline, ConstObstacleCost, NegGeom, AABoxes, UnionGeom, AdditiveCosts, \
    ConstCost
import numpy as np
...
def create_small_domain(start, goal):
    cost_fn = create_cost_small()
...
def main():
    ...
    f(x)
    x1 = np.random.uniform(x_range[0]+0.5, x_range[1]-0.2)
    print('Input = {}'.format(x))
    print('Output = {}'.format(f(x1)))
